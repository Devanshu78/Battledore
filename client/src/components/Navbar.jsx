...
function Navbar() {
  ...
  return (
    <div>
      <nav className="w-[550px] h-5/6 bg-[#7CB6CB]  px-24 py-6 rounded-[107px] flex flex-col items-end justify-between rows-3 relative top-[60px] -left-[218px] ">
        <ul className="text-white flex flex-col gap-7 text-2xl">
          <li>
            <NavLink
              to="home"
              className={({ isActive }) =>
          ...
          <li className="border-b-2 text-[#7CB6CB] mb-4"></li>
        </ul>
        <ul className="text-white flex flex-col gap-5 text-2xl w-[187px]">
          <li>
            <NavLink
              to="user/setting"
              className={({ isActive }) =>
          ...
          <button
            ...
            className="border transition duration-300 ease-out hover:ease-in hover:scale-y-110 text-center rounded-xl py-1 cursor-pointer"
          >
            Logout
          </button>
        </ul>
