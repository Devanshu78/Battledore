...
function Navbar() {
  ...
  return (
    <div>
      <nav className="h-[80%] bg-[#7CB6CB] pl-24 pr-5 md:pr-10 py-10 rounded-[107px] flex flex-col items-end justify-between relative top-14 md:top-24 md:text-nowrap">
        <ul className="text-white flex flex-col gap-7 text-sm md:text-xl lg:text-2xl">
          <li>
            <NavLink
              to="home"
              className={({ isActive }) =>
          ...
          <li>
            ...
            >
              ...
              <span className="hidden md:block">Courts schedule</span>
            </NavLink>
          </li>
          <li className="border-b-2 text-[#7CB6CB] mb-4"></li>
        </ul>
        <ul className="text-white flex flex-col gap-5 sm:text-md md:text-2xl md:w-[190px]">
          <li>
            <NavLink
              to="user/setting"
              className={({ isActive }) =>
