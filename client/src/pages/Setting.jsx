...
function Setting() {
  ...
  return (
    <>
      ...
      <hr />
      <div>
        <div className="mt-8 flex flex-col md:flex-row md:justify-between items-center gap-2 text-3xl font-inter">
          <div id="about_event" className="lg:flex gap-6 w-full h-auto">
            <img className="w-36 rounded-2xl" src="../badminton.jpg" alt="" />
            <div className="text-white text-lg h-auto text-nowrap mt-5 flex flex-col  gap-2 md:gap-4">
              <p className="font-light">
                ...
                <input
                  ...
                  readOnly={!isEditable}
                  className={`font-bold uppercase w-[80%] md:w-auto text-xl text-[#B1D848] bg-transparent outline-none ${
                    isEditable
              ...
              <p className="font-light">
                ...
                <input
                  ...
                  readOnly={!isEditable}
                  className={`font-bold bg-transparent w-[80%] md:w-auto outline-none ${
                    isEditable
                      ? "border border-gray-300 rounded-lg px-2"
                      : "border-transparent"
                  } `}
